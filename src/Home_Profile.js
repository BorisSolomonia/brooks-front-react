...
//   useEffect(() => {
//     // Fetch places and initialize the map logic
//   }, [token]);
...
//             Cancel
//           </Button>
//           <Button onClick={handleSavePlace} color="primary" disabled={loading}>
//             {loading ? <CircularProgress size={24} /> : 'Save'} {/* Show spinner when loading */}
//           </Button>
//         </DialogActions>
//       </Dialog>
//       {alertPlace && (
